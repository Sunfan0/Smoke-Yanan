	...
	<body>
		<div id="maincontainer" class="float hidden fullScreen" style="overflow:hidden;">  
			...
			<div id="pageImg" class="float video">
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video1-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video2-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video3-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video4-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video5-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video6-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video7-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video8-col4.jpg" class="float hidden" >
				<img crossorigin="anonymous"   data-src="<?=$imgPath?>video9-col4.jpg" class="float hidden" >
...
// ----
		...
		function OnLoad(){	
			...
			canvidControl = canvid({
				selector : '.video',
				videos: {
					clip1: { src: '<?=$imgPath?>video1-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip2');
					}},
					clip2: { src: '<?=$imgPath?>video2-col4.jpg', frames: 177, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip3');
					}},
					clip3: { src: '<?=$imgPath?>video3-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip4');
					}},
					clip4: { src: '<?=$imgPath?>video4-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip5');
					}},
					clip5: { src: '<?=$imgPath?>video5-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip6');
					}},
					clip6: { src: '<?=$imgPath?>video6-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip7');
					}},
					clip7: { src: '<?=$imgPath?>video7-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip8');
					}},
					clip8: { src: '<?=$imgPath?>video8-col4.jpg', frames: 175, cols: 4, loops: 1,fps:15, onEnd: function(){
						canvidControl.play('clip9');
					}},
					clip9: { src: '<?=$imgPath?>video9-col4.jpg', frames: 98, cols: 4,loops: 1,fps:15, onEnd: function(){
						$("#pageImg").hide();
						$("#startLight1").hide();
						$("#startLight").hide();
						imgAudio.pause();
