            ...
            loadImages(_opts.videos, function(err, images) {
                ...
                control.play = function(key, reverse, fps) {
                    ...
                    function frame() {
						...
						nextFrameTime = lastFrameTime + 1000 / curFps; 
						
                        //if (!wait) {
						if(nowTime >= nextFrameTime || lastFrameTime == 0){
							lastFrameTime += 1000 / curFps;
                            drawFrame(curFrame);
...
//console.log("end : " + new Date().getTime());
        ...
        WebGL2D.enable(canvas); // adds new context "webgl-2d" to cvs
